...
@Component({
  selector: 'app-statistics5',
  templateUrl: './statistics5.component.html',
  styleUrls: ['./statistics5.component.scss']
})

export class Statistics5Component implements OnInit {
